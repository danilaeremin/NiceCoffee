 ...
 */
public class CategoryGridAdapter extends ArrayAdapter<Integer> {
    ...
    // Конструктор
    public CategoryGridAdapter(Context context, String[] drawerMainElements, Integer[] drawerMainElementsPics) {
        super(context, R.layout.main_fragment_grid_category_buttons, drawerMainElementsPics);
