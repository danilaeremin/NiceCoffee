...
public class ProductContract {
    ...
    public static final class ProductEntry implements BaseColumns {
        ...
        public static Uri buildProductUri(Integer id) {
            return ContentUris.withAppendedId(CONTENT_URI.buildUpon().appendPath(COLUMN_PRODUCT_ID).build(), id);
        }

        public static Uri buildProductUriWithCategory (Integer id) {
            return ContentUris.withAppendedId(CONTENT_URI.buildUpon().appendPath(COLUMN_PRODUCT_CATEGORY).build(), id);
        }
    ...
    public static final class CategoriesEntry implements BaseColumns {
        ...
        public static Uri buildCategoryUri(long id) {
            return ContentUris.withAppendedId(CONTENT_URI.buildUpon().appendPath(COLUMN_CATEGORY_ID).build(), id);
        }
        public static Uri buildCategoryUriWithParent (Integer id) {
            return ContentUris.withAppendedId(CONTENT_URI.buildUpon().appendPath(COLUMN_PARENT_ID).build(), id);
        }
        ...
        public static String getParentIdFromUri(Uri uri) {
            return uri.getLastPathSegment();
        }
    }
}
